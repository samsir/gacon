...
if(c==1)
{out+='<div id="tipue_search_results_count" class="badge badge-pill badge-light mb-4">'+tipuesearch_string_4;}
else
{c_c=c.toString().replace(/\B(?=(\d{3})+(?!\d))/g,",");out+='<div id="tipue_search_results_count" class="badge badge-pill badge-light mb-4">'+c_c+' '+tipuesearch_string_5;}
if(set.showTime)
...
{out+='<div class="tipue_search_content_title"><h3><a href="'+found[i].url+'"'+tipue_search_w+'>'+found[i].title+'</a></h3></div>';if(set.debug)
...
{t_d+=' ...';}
t_d=t_d.replace(/h0011/g,'span class=\"tipue_search_content_bold badge p-0\"');t_d=t_d.replace(/h0012/g,'/span');out+='<div class="tipue_search_content_text mb-4">'+t_d+'</div>';}}
l_o++;}
